...
<b-container class="bv-example-row">
    ...
    <h1>EDIT PRODUCT {{ comment.id }}</h1>
    <hr>
 <form class="box3" v-on:submit.prevent="editComment">
      <p>PRODUCT NAME: <input type="text" class="form-control" v-model="comment.title" /></p>
 ...
 <transition name="fade"> 
  ...
  <form enctype="multipart/form-data" novalidate>
              <div class="dropbox">
                ...
                <p v-if="isSuccess">Upload Success!</p>
                <p v-if="isFailed">Upload Unsuccess!</p>
              </div>
