<template>
  <div>
    ...
    <center><h1>Edit Order: {{ blog.id }} </h1><hr></center>
    ...
    <form class="box1" v-on:submit.prevent="editBlog">
     <p> Name : <input type="text" class="form-control" v-model="blog.firstname" /> </p>
            ...
            <p> Address : <input type="text" required class="form-control" v-model="blog.other" /></p>

<hr>

      <p>
        <b-button pill variant="warning" type="submit"> CONFIRM EDIT</b-button>
