...
module.exports = (app) => {
 ...
 //room route
  ...
  //edit blog, suspend, active
  app.put('/home/:homeId',HomeController.put)
  //delete room
  app.delete('/home/:homeId',HomeController.remove)
  //get room by id 
  app.get('/home/:homeId',HomeController.show)
  //get all room
  app.get('/homes',HomeController.index)
